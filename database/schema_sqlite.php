...
function sqlite_schema(): array
{
    return [
        ...
        "CREATE TABLE orders (id INTEGER PRIMARY KEY AUTOINCREMENT, reference TEXT UNIQUE, customer_id INTEGER, customer_name TEXT, email TEXT, phone TEXT, subtotal REAL DEFAULT 0, discount REAL DEFAULT 0, total REAL DEFAULT 0, payment_method TEXT DEFAULT 'baridimob', payment_ref TEXT, order_number TEXT, satim_order_id TEXT, approval_code TEXT, resp_code TEXT, pan TEXT, card_brand TEXT, paid_at TEXT, receipt_file TEXT, status TEXT DEFAULT 'pending', note TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)",
