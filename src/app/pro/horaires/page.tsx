  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-5 py-8 sm:px-8 sm:py-10">
      ...
      {query.enregistre && (
        <p
          role="status"
          className="mt-5 border border-azur-600/40 bg-azur-100 px-4 py-3 text-[15px] text-ink-900"
        >
      ...
      <form action={saveHours} className="mt-8">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          <button
            type="submit"
            className="min-h-11 bg-azur-500 px-5 py-3 font-display text-sm font-bold tracking-[0.06em] text-azur-950 uppercase hover:bg-azur-400"
          >
          ...
          <button
            ...
            name="intent"
            value="copier"
            className="min-h-11 border border-azur-700 px-5 py-3 font-display text-sm font-bold tracking-[0.06em] text-azur-700 uppercase hover:bg-azur-100"
          >
      ...
      <section id="fermetures" className="mt-12">
        ...
        >
          ...
          <button
            type="submit"
            className="min-h-11 self-start border border-azur-700 px-5 py-3 font-display text-sm font-bold tracking-[0.06em] text-azur-700 uppercase hover:bg-azur-100"
          >
