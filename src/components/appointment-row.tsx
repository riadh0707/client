    ...
    <article className="bg-enamel-50 p-4 sm:p-5">
      <div className="flex flex-wrap items-start justify-between gap-x-4 gap-y-2">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5">
            {perspective === "patient" ? (
              <Link
                ...
                className="flex min-h-11 items-center font-display text-base font-bold text-ink-900 hover:text-azur-700 sm:text-lg"
              >
          ...
          <p className="mt-1 font-display text-sm tabular-nums text-azur-700">
